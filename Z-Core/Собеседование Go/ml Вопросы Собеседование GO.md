...
- Чем представлен интерфейс в Go?
...
- Расскажи про синхронную и асинхронную репликацию в базах данных.
- Как забатчить кучу апдейтов в таблице?
- Зачем нужны индексы в базах данных?
- Какие есть отрицательные эффекты от индексов?
- Когда использовать триггеры в бд?
- Что делать если тормозит запрос к базе? Explain и Explain Analyze, отличия.
- Что такое notify в postgresql?
- Есть составной индекс на поля юзера - first name и last name. Делаем запрос на last name. Сработает ли индекс?
- Как работает составной индекс?
- Как диагностировать почему база медленная?
- Эффективно ли индексировать булевые поля в базе?
- Работал ли со вложенными транзакциями?
- Расскажи про блокировки в базах данных.
- Уровни изоляции в базах данных
- Что такое gin индекс?
- Как прочитать большой файл с конца?
...
- Почему на го можно запустить 100к горутин?
